...
public class ApiTest {
    ...
    public void answer() throws IOException {
        ...
        HttpPost post = new HttpPost("https://api.zsxq.com/v2/topics/814281821414122/answer");
